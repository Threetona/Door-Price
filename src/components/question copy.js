...
const styles = {
    ...
    questionPaper: {
        ...
        marginTop: '20px',
        marginBottom: '0px',
        display: 'flex',  // Menambah properti display untuk menggunakan flexbox
        alignItems: 'center',  // Menambah properti alignItems untuk menengahkan secara vertikal
        justifyContent: 'center',  // Menambah properti justifyContent untuk menengahkan secara horizontal
    },
...
function Question() {
    ...
    const startTimer = () => {
        ...
        // Memulai timer hanya jika permainan sudah dimulai dan tombol "Start Timer" sudah ditekan
